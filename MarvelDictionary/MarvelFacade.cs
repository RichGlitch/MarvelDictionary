...
namespace MarvelDictionary
{
    public class MarvelFacade
    {
        private const string PrivateKey = "90dfbc7e33fb68d3dfb58ec6487db9b1fa491d96";
        private const string PublicKey = "942f507e88b4db153dfb0b01603c075a";
        ...
        private async static Task<CharacterDataWrapper> GetCharacterDataWrapperAsync()
        {
            ...
            var url = String.Format("http://gateway.marvel.com:80/v1/public/characters?limit=10&offset={0}", offset);
        ...
        {
            var url = String.Format("http://gateway.marvel.com:80/v1/public/comics?characters={0}&limit=2", characterId);
            var jsonMessage = await CallMarvelAsync(url);
